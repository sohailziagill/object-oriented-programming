...
{
	cout<<"\n Enter the number of total yearly bonus   ";
	cin>>bonus;
	cout<<"\n Enter the number of stock share          ";
	cin>>shareStock;
}
void executive::putdata()
{
	cout<<"\n The bonus is of the executive manager is  "<<bonus;
	cout<<"\n The stock share is                        "<<shareStock;
}
/////////////////////////////////////////////////////////////////////////////////////////////////////
